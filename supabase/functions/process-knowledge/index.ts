...
serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      } else if (fileType.includes("pdf") || fileType.includes("word") || fileType.includes("document") || fileType.includes("spreadsheet") || fileType.includes("excel")) {
        // For complex document types, use Oracle AI to extract text
